...
import { Subject, Observable, of } from 'rxjs' // observable, like streams of data, kinda like arrays where data arrives over time.
...
export class EventService{
    ...
    getEvents():Observable<IEvent[]>{
        ...
        // setTimeout(() => {subject.next(EVENTS); subject.complete();}, 100); //adding data to the observable stream and using it with set timeout to simulate asynchrony. Add data after 100 ms
        // return subject;
    ...
    //   EVENTS[index] = event
    // } Dont need this because saveEvent does both
